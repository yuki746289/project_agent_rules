...
### 開発手順
  ...
  |8|仕様|`rules_{dev}_8_spec.md`|プロジェクト直下の`document`フォルダの `仕様_差分_v{n}.{m}.md`<br>プロジェクト直下の`document`フォルダの `仕様_全体_v{n}.{m}.md`|
  |9|仕様確認|`rules_{dev}_9_spec_confirm.md`|プロジェクト直下の`document`フォルダの `仕様確認_v{n}.{m}.md`|

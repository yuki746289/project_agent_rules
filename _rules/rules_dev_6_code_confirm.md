...
**出力ファイル名:** `{filename}_v{n}.{m}_code_confirm.md`
...
### 2. 品質・仕様チェック
- [ ] **JSONカバレッジ:** `{filename}_v{n}.{m}_detail.json` で定義された全ての機能・制約を 100% カバーしているか。
...
### 確認結果のレポート形式
出力ファイル `{filename}_v{n}.{m}_code_confirm.md` には、以下の「最終判定レポート」を記述して下さい。
